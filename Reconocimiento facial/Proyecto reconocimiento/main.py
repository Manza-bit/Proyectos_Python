...
#crear base de datos
ruta = "C:\\Users\\pedru\\Desktop\\PythonProject4\\Proyecto reconocimiento\\Empleados"
mis_imagenes=[]
nombres_empleados = []
...
def codificar(imagenes):
    ...
    for imagen in imagenes:
        ...
        #agreagar a la lista codificada
...
def registrar_ingreso(persona):
    ...
    for linea in lista_datos:
        ingreos = linea.split(",")
        nombres_registro.append(ingreos[0])
